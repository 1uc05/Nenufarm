/*! 
 * \file         StartManager.cpp
 * \brief
 * \author       Lucas TEISSIER
 * \date         29/01/2024 15:10:54
 * \warning
...
PB: impossible de faire de polymorphisme ni d'allocation dynamique
-> impossible d'ecraser le Handler mère par une fille
-> impossible d'utiliser new et delete (gcc limité en c++, lib ATTiny réduite sur archi AVR)
*/
